...
@implementation XYWaterFlowLayout

-(instancetype)init{
    self = [super init];
    if (self) {
        self.columnCount = WSLDefaultColumeCount;
        self.rowCount = WSLDefaultRowCount;
    }
    return self;
}
...
-(void)prepareLayout {
    ...
    if (self.flowLayoutStyle == XYFlowVerticalEqualWidth) {
    ...
    }else if (self.flowLayoutStyle == XYFlowHorizontalEqualHeight){
    ...
    }else if (self.flowLayoutStyle == XYFlowVerticalEqualHeight || self.flowLayoutStyle == XYFlowLineWaterFlow){
    ...
    }else if(self.flowLayoutStyle == XYFlowHorizontalGrid){
...
-(UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    }else if(self.flowLayoutStyle == XYFlowVerticalEqualHeight){
        attrs.frame = [self itemFrameOfVHWaterFlow:indexPath];
    }else if(self.flowLayoutStyle == XYFlowLineWaterFlow){
...
/*
 ...
 {
 if (self.flowLayoutStyle == XYFlowLineWaterFlow) {
...
- (CGRect)itemFrameOfVerticalWaterFlow:(NSIndexPath *)indexPath{
    ...
    NSLog(@"1:%f-----%@",self.maxColumnHeight,self.columnHeights);
...
- (CGRect)itemFrameOfVHWaterFlow:(NSIndexPath *)indexPath{
    ...
    NSLog(@"2:%f-----%@",self.maxColumnHeight,self.columnHeights);
    return CGRectMake(x, y, w, h);
...
- (CGRect)itemFrameOfHorizontalWaterFlow:(NSIndexPath *)indexPath{
    ...
    NSLog(@"3:%f-----%@",self.maxColumnHeight,self.columnHeights);
    return CGRectMake(x, y, w, h);
...
- (CGRect)itemFrameOfHorizontalGridWaterFlow:(NSIndexPath *)indexPath{
    ...
    NSLog(@"4:%f-----%@",self.maxColumnHeight,self.columnHeights);
    return CGRectMake(x, y, w, h);
...
- (CGRect)itemFrameOfLineWaterFlow:(NSIndexPath *)indexPath{
    ...
    NSLog(@"5:%f-----%@",self.maxColumnHeight,self.columnHeights);
    return CGRectMake(x, y, w, h);
}
